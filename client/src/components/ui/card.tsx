  ...
  "rounded-2xl text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        elevated: "bg-card border border-border/50 shadow-medium hover:-translate-y-1 hover:shadow-lg",
        glass: "bg-card/80 backdrop-blur-xl border border-border/50 shadow-card",
        stat: "bg-card border border-border/50 shadow-card hover:scale-[1.02] cursor-pointer",
        outline: "border border-border bg-transparent",
        gradient: "bg-gradient-to-br from-card to-muted/30 border border-border/50 shadow-card",
      },
    },
    defaultVariants: {
      variant: "default",
